package com.comvee.cdms.education.controller.web;
 ...
 */
@RestController
@RequestMapping("/web/edu")
public class WebDistanceEducationController {
    ...
    public Result addDoctorCollect(@Validated EduCourseDoctorDTO eduCourseDoctorDTO) {
        eduCourseDoctorDTO.setOrigin(EducationCourseConstant.EDUCATION_ORIGIN_WEB);
    ...
    public Result publishComment(@Validated AddEduCourseCommentDTO addEduCourseCommentDTO) {
        addEduCourseCommentDTO.setOrigin(EducationCourseConstant.EDUCATION_ORIGIN_WEB);
     ...
     * @return
     */
    @RequestMapping("loadRecCourseList")
    public Result loadRecCourseList(String courseId) {
        ValidateTool.checkParameterIsNull("courseId",courseId);
        List<ListEduCourseVO> listEduCourseVOS = educationCourseService.recommendCourseList(courseId);
        return Result.ok(listEduCourseVOS);
    }
