...
public class ListUtils {
    ...
    //List<map>根据key排序，asc true升序false降序
    public  static void sortListMapByKey(List<Map> mapList,String key,Boolean asc){
        mapList.sort(new Comparator<Map>() {
            ...
            public int compare(Map o1, Map o2) {
                ...
                if (o2.get(key) == null)
                    return 1;
                int i = o1.get(key).toString().compareTo(o2.get(key).toString());
                if (asc){
                    return i;
                }
                return -i;
