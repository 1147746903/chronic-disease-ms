...
public class AlgorithmUtils {
     ...
     * @return a1*a2*a3*a4...
     */
    public static double multiply(String newScale, double a1, double a2, double... a) {
        return calculate(Integer.parseInt(newScale), DEFAULT_ROUNDINGMODE, OpType.Multiply, a1, a2,
                a);
    }
     ...
     * @return a1*a2*a3*a4...
     */
    public static double multiply(int roundingMode, String newScale, double a1, double a2,
            double... a) {
        return calculate(Integer.parseInt(newScale), roundingMode, OpType.Multiply, a1, a2, a);
    }
     ...
     * @return a1/a2/a3/a4...
     */
    public static double divide(String newScale, double a1, double a2, double... a) {
        return calculate(Integer.parseInt(newScale), DEFAULT_ROUNDINGMODE, OpType.Divide, a1, a2, a);
    }
     ...
     * @return a1/a2/a3/a4...
     */
    public static double divide(int roundingMode, String newScale, double a1, double a2,
            double... a) {
        return calculate(Integer.parseInt(newScale), roundingMode, OpType.Divide, a1, a2, a);
    }

    private static double calculate(OpType opType, double a1, double a2, double... a) {
    ...
    private static double calculate(int newScale, int roundingMode, OpType opType, double a1,
            double a2, double... a) {
        BigDecimal b1 = new BigDecimal(a1 + "");
        BigDecimal b2 = new BigDecimal(a2 + "");
        BigDecimal tmp;
        if (OpType.Add.equals(opType)) {
            ...
            for (int i = 0; i < a.length; i++) {
                tmp = tmp.divide(new BigDecimal(a[i] + ""), DEFAULT_NEWSCALE, roundingMode);
            }
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(add(1.1, 2.3, 3.3, 4));
        ...
        System.out.println(divide("2", 1, 3));
