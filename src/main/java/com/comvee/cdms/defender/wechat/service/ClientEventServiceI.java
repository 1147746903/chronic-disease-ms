/**
 * @File name:   ClientEventServiceI.java  用户行为日志埋点 service层接口
...
public interface ClientEventServiceI {
	 ...
	 */
	ClientEventModel loadClientEventById(Long sid) ;
	 ...
	 * @date 2018-9-18 14:20:31
	 */
	List<ClientEventModel> loadClientEvent(PageRequestModel pager) ;
