...
@RestController
@RequestMapping("/third/hba1c")
public class ThirdHba1cController {
    ...
    public Result addHba1c(@Validated AddHba1cDTO addHba1cDTO){
        ...
        addHba1cDTO.setOperatorId(Constant.DEFAULT_FOREIGN_ID);
        addHba1cDTO.setHospitalId(addHba1cDTO.getHospitalId());
        addHba1cDTO.setHospitalName(addHba1cDTO.getHospitalName());
